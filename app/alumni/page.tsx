  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="absolute left-7 top-7 text-[11px] tracking-[0.3em] text-[#2A2D31]/25 transition-colors duration-500 group-hover:text-[#C49A4A]/70"
        ...
        <div className="relative mx-auto h-32 w-32 shrink-0">
          ...
          <div className="pointer-events-none absolute -inset-0.5 rounded-full bg-[#C49A4A]/25 opacity-0 blur-md transition-opacity duration-700 ease-out group-hover:opacity-60" />
          ...
          {person.image ? (
            ...
            <div className="relative flex h-32 w-32 items-center justify-center rounded-full bg-[#C49A4A]/12 text-xl font-semibold text-[#C49A4A] ring-1 ring-[#C49A4A]/30 transition-transform duration-700 ease-out group-hover:scale-105">
        ...
        <div className="mt-4 flex w-full flex-col items-center gap-2.5">
          <div className="h-px w-10 bg-[#2A2D31]/12 transition-all duration-500 group-hover:w-16 group-hover:bg-[#C49A4A]/40" />
          <p
