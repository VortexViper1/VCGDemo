    ...
    >
      ...
      >
        ...
        >
          {/* Avatar */}
          <span
            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#F6E3CC] text-xs font-medium text-[#B8661A] ring-1 ring-[#C49A4A]/35 transition-opacity duration-300 ${
              loading
                ? "opacity-0"
                : "opacity-100"
            }`}
          ...
          <ChevronDown
            size={13}
            strokeWidth={2}
            className={`text-[#9A958D] transition-transform duration-200 ${
              menuOpen
                ? "rotate-180"
                : ""
            }`}
        ...
        {menuOpen && (
          ...
          >
            ...
            <Link
              ...
              role="menuitem"
              className="flex h-10 items-center gap-2.5 rounded-lg px-2 text-sm text-[#4B4A47] transition-colors duration-150 hover:bg-[#F3E5D2] hover:text-[#B8661A] hover:text-[#23272B]"
            >
              <Settings
                size={16}
                strokeWidth={1.8}
