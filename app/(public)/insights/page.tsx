    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {PARTICLES.map((p, i) => (
        <motion.span
          ...
          className="absolute bottom-0 rounded-full bg-[#D9822B] shadow-[0_0_8px_2px_rgba(201,163,95,0.6)]"
        />
      ))}
    </div>
  );
                  ...
                  <div className="grid gap-10 lg:grid-cols-2">
                    ...
                    <div>
                      <div className="flex items-center gap-3">
                        <span className="rounded-full border border-[#C49A4A]/30 bg-[#D9822B]/12 px-4 py-2 text-xs uppercase tracking-[0.25em] text-[#D9822B]">
                          Featured Insight
                        </span>
                      </div>
...
<div className="relative flex min-h-[460px] items-center justify-center overflow-hidden rounded-[32px] bg-[#0C2234]">
  ...
  <div className="absolute h-[340px] w-[340px] rounded-full bg-[#D9822B]/12 blur-[120px]" />
  ...
  <motion.span
    ...
    className="absolute left-[20%] top-[25%] h-2 w-2 rounded-full bg-[#D9822B]"
  />

  <motion.span
    animate={{ y: [8, -8, 8] }}
    transition={{ duration: 8, repeat: Infinity }}
    className="absolute right-[18%] bottom-[28%] h-2 w-2 rounded-full bg-[#D9822B]"
  />
                ...
                <Link href={article.href} className="block h-full">
                  ...
                  >
                    <GlassCard className="group flex h-full flex-col overflow-hidden">
                      <span className="inline-flex w-fit items-center rounded-full border border-[#C49A4A]/30 bg-[#D9822B]/12 px-3.5 py-1.5 text-[11px] uppercase tracking-[0.2em] text-[#D9822B]">
                        {article.category}
                      </span>

                      <h3
                        className="mt-6 text-xl font-semibold leading-snug transition-colors duration-300 group-hover:text-[#D9822B]"
                        style={{ color: "#2A2D31" }}
                      >
                        {article.title}
                      </h3>
