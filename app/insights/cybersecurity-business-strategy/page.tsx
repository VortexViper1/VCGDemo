  ...
  return (
    <main className="min-h-screen bg-[#F8F5EF]">
      ...
      <Section className="pt-40">
        ...
        <Reveal delay={0.2}>
          <div className="relative mx-auto mt-16 flex h-[280px] max-w-5xl items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-[#123A53] via-[#0E2B40] to-[#23272B] sm:h-[340px]">
            <motion.div
              animate={{ rotate: [0, 360] }}
              transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
              className="absolute h-64 w-64 rounded-full border border-[#C49A4A]/20 sm:h-80 sm:w-80"
            />
            <motion.div
              animate={{ rotate: [360, 0] }}
              transition={{ duration: 32, repeat: Infinity, ease: "linear" }}
              className="absolute h-44 w-44 rounded-full border border-[#2A2D31]/8 sm:h-56 sm:w-56"
            />
           <Image
