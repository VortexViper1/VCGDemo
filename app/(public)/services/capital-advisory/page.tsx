            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {OUTCOMES.map((outcome) => (
                <div key={outcome} className="flex items-start gap-3">
                  <CheckCircle2
                    size={18}
                    className="mt-0.5 shrink-0 text-[#D9822B]"
                  />
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                <button
                  ...
                  onClick={() => setActivePillar(null)}
                  aria-label="Close"
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#2A2D31]/10 text-[#2A2D31]/60 transition-colors duration-300 hover:border-[#C49A4A]/40 hover:text-[#D9822B]"
                >
                  <X size={18} />
                </button>
              </div>
